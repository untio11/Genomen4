...
public class Animator {
     ...
     * model-space transform of the bone. This basically "subtracts" the
     * bone's original bind (no animation applied) transform from the desired
     * pose transform. The result of this is then the transform required to move
     * the bone from its original model-space transform to it's desired
     ...
     *            - the desired model-space transform of the parent bone for
     *            the pose.
     */
