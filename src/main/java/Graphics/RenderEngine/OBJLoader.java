...
public class OBJLoader {
    ...
    public static RawModel loadObjModel(String fileName, Loader loader) {
        ...
        float[] color = {};
        return loader.loadToVAO(verticesArray, textureArray, normalsArray, color, indicesArray);

    }

    private static void processVertex(String[] vertexData, List<Vector2f> textures, List<Vector3f> normals,
                                      List<Integer> indices, float[] textureArray, float[] normalsArray) {
