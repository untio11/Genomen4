...
public abstract class Entity {
    ...
    protected float rotX = 0f; // Pitch
    protected float rotY = 0f; // Roll
    protected float rotZ = 0f; // Yaw
    ...
    public String toString() {
        return String.format("[%s]: position(%f, %f, %f), rotation(%f, %f, %f)", ID, position.x, position.y, position.z, rotX, rotY, rotZ);
    }
}
